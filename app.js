...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Send via EmailJS
            // Note: Make sure your EmailJS template contains an attachment variable or message variable configured
            // according to your EmailJS settings. Here we send it as 'content' or 'attachment'.
            const templateParams = {
                patient_name: patientName,
                patient_phone: patientPhone,
                message: `تم استلام نموذج جديد للمريض ${patientName}`,
                // If you are using base64 attachments in EmailJS, map it here:
                content: pdfDataUri 
            };
            ...
            Swal.fire({
                icon: 'error',
                title: 'حدث خطأ',
                text: 'لم نتمكن من إرسال النموذج، يرجى التأكد من مفاتيح EmailJS أو المحاولة مرة أخرى.',
